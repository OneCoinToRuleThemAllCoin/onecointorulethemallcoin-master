...
// Copyright (c) 2013 OnecointorulethemallCoin Developers
...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // OnecointorulethemallCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "OnecointorulethemallCoin Signed Message:\n";
...
static int64 nTargetTimespan = 10 * 60; // OnecointorulethemallCoin: every 4 hours
static int64 nTargetSpacing = 60; // OnecointorulethemallCoin: 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // OnecointorulethemallCoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal onecointorulethemallcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "OnecointorulethemallCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // OnecointorulethemallCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)

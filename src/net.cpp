...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "OnecointorulethemallCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    ...
    // {"onecointorulethemallcoinpool.org", "dnsseed.onecointorulethemallcoinpool.org"},
...
void ThreadOpenAddedConnections(void* parg)
{
    ...
    // Make this thread recognisable as the connection opening thread
    RenameThread("onecointorulethemallcoin-opencon");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. OnecointorulethemallCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("onecointorulethemallcoin-start");
